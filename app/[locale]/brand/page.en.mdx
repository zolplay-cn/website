...
Our primary color is Space Gray, comfortable on light and dark surfaces. For monochrome wordmark usage, prefer black, white, or Space Gray. Keep accents minimal and consistent with the system.
...
<Grid cols={1} md={2} gap={4} className='my-6'>
  ...
  <GridItem className='overflow-hidden p-0 flex flex-col gap-4 w-full bg-[#262626]'>
    <div className='px-4 py-12 text-sm'>
      <span className='block text-neutral-300'>Space Gray</span>
