...
<NakedImage
  src={headline}
  alt='Zolplay Headline Illustration'
  priority
  className='block visible dark:hidden dark:invisible'
/>
<NakedImage
  src={headlineDark}
  alt='Zolplay Headline Illustration'
  priority
  className='mt-0 hidden invisible dark:block dark:visible'
/>

# A <Gradient>design studio</Gradient> for people with good taste
