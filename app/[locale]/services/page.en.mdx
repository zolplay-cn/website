...
<FAQ title="Frequently Asked Questions">
  <FAQItem question="What’s included in a subscription?">
    Your subscription includes weekly design hours, async collaboration, and senior‑level execution focused on high‑impact outcomes.
  </FAQItem>
  <FAQItem question="Can I switch plans later?">
    Yes. You can upgrade or downgrade anytime to match your pace and priorities.
  </FAQItem>
  <FAQItem question="Do you support project‑based work?" defaultOpen>
    We do. Book a discovery call and we’ll scope a custom plan.
  </FAQItem>
</FAQ>
