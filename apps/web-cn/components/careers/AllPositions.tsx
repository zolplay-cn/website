  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg absolute inset-0 rounded-2xl bg-gradient-bg shadow-in-dark"
      />
      <motion.div
        variants={backCard1Variants}
        transition={springTransition}
        className="bg absolute inset-0 rounded-2xl bg-slate-900 shadow-in-dark"
      />
      <motion.div
      ...
      >
        ...
        >
          ...
          <div className="relative mb-4 flex h-14 w-14 items-center justify-center">
            ...
            <Icon className="z-20 h-8 w-8 text-slate-800" />
          </div>
          <strong
            className={clsxm(
...
const AllPositions: UIComponent = ({ className }) => {
  return (
    <section
      className={clsxm(
        'flex min-h-[500px] flex-nowrap place-content-center place-items-center content-center justify-start space-x-8 overflow-x-scroll bg-dark bg-cover bg-repeat px-24 py-20',
        className
      )}
    >
      {jobs.map((job, i) => (
