      ...
      <AnimatePresence>
        {totalUsers >= 1 && (
          ...
          >
            <Tippy
              content={
                <span className="tippy-block flex-col items-center text-sm">
                  <span className="mb-1 flex items-center space-x-1.5 text-slate-200">
                    <UserGroupIcon className="h-3.5 w-3.5" />
                    <span>
                      {totalUsers > 1
                        ? `${totalUsers} others are `
                        : 'Another user is '}
                      viewing
                    </span>
                  </span>
                  <span className="flex items-center space-x-1.5 font-medium text-slate-400">
                    ...
                    <span>Press / for cursor chat</span>
                  </span>
                </span>
              }
              interactive={false}
        ...
        <main className="container relative z-50 flex w-full items-center justify-between px-2 lg:px-6">
          ...
          >
            <SiteLink href="/" strict>
              <NeonLogo type="sm" />
              <div className="hidden lg:-ml-1.5 lg:flex lg:items-center">
