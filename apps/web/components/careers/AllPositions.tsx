        ...
        >
          ...
          <div className="grid w-full flex-1 grid-cols-3 gap-4">
            ...
            >
              ...
              <span className="flex items-center text-xs font-medium text-sky-400">
                {minYearsExperience}yr+
              </span>
            </div>
            <div
              className="flex flex-col items-center justify-center"
            ...
            >
              ...
              >
                ...
                <span className="pl-0.5 text-xs">Remote</span>
              </span>
            </div>
          </div>
