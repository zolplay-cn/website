      ...
      <div className='w-full h-full relative mx-2 pt-1.5 flex border-x border-(--grid-border-color)'>
        ...
        <nav data-orientation='horizontal' className='relative z-2 w-full py-3 px-4 flex justify-between gap-4'>
          ...
          <Drawer.Root open={isOpen} onOpenChange={setIsOpen}>
            ...
            <Drawer.Portal>
              <Drawer.Overlay className='fixed left-0 right-0 bottom-0 top-[30dvh] z-50 mask-t-from-80% bg-white/70 dark:bg-black/70 backdrop-blur-lg backdrop-saturate-150' />
              <Drawer.Content
                className={clsxm(
